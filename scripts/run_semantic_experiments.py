...
EXPERIMENTS = [
    ...
    {
        "name": "char-onnx-sgd-t030",
        "description": "Plain character ngram SGD model that exports through skl2onnx.",
        "args": [
            "--analyzer",
            "char",
            "--ngram-min",
    ...
    {
        "name": "char-onnx-sgd-t020",
        "description": "Plain character ngram SGD model with lower recall-oriented threshold.",
        "args": [
            "--analyzer",
            "char",
            "--ngram-min",
    ...
    {
        "name": "word-sgd-onnx-t020",
        "description": "Word 1-2gram SGD with aggressive threshold for hard-suite recall.",
        "args": [
            "--analyzer",
            "word",
            "--ngram-min",
    ...
    {
        "name": "word-sgd-onnx-t014",
        "description": "Word 1-2gram SGD threshold tuned for best current hard-suite accuracy.",
        "args": [
            "--analyzer",
            "word",
            "--ngram-min",
