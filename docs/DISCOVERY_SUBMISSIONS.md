...
| Hacker News | technical launch | draft | Use only when repo has integration examples and benchmark page |
| Lobsters | programming/security launch | draft | Avoid marketing tone |
